...
Adapted for AgentHippo from upstream plugin source: commit-commands
...
- Includes AgentHippo attribution in commit message
...
This pack is available from AgentHippo Store. Install it with `agenthippo store install pack/commit-commands`.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let AgentHippo analyze your changes and match your repo's commit style
...
- **Let AgentHippo draft messages**: The commit message analysis learns from your repo's style
